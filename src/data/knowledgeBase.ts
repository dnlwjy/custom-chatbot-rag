...
export const KNOWLEDGE_BASE_CHUNKS: KnowledgeChunk[] = [
  // Artificial Intelligence Page Chunks
  {
    id: "ai-1",
  ...
  },
  {
    ...
    pageTitle: "Quantum Computing",
    url: "/services",
    text: "Building practical quantum computers remains an extraordinary engineering challenge. Qubits are extremely sensitive to environmental interference, making error correction and hardware stability difficult to achieve. Researchers continue developing new architectures, cooling systems, and algorithms to overcome these limitations while technology companies and governments invest billions of dollars into quantum research. Although widespread commercial adoption may still be years away, quantum computing is widely regarded as one of the technologies most likely to redefine the future of computation and scientific discovery."
  },

  // Space Exploration Page Chunks
  {
    id: "space-1",
    category: "Space Exploration",
    pageTitle: "Space Exploration",
    url: "/contact",
